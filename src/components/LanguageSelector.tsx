function LanguageSelector() {
  const FLAGS = [{
    language: "en",
    flag: <svg className="w-[1em] h-[1em]" xmlns="http://www.w3.org/2000/svg"
               id="flag-icons-us"
               viewBox="0 0 640 480">
    ...
    flag: <svg className="w-[1em] h-[1em]" xmlns="http://www.w3.org/2000/svg"
      ...
      <path fill="none" stroke="#000" strokeWidth=".4"
      ...
      <path fill="none" stroke="#000" strokeLinejoin="round" strokeWidth=".4"
      ...
      <path fill="none" stroke="#000" strokeWidth=".1"
      ...
      <path fill="#c8b100" stroke="#000" strokeWidth=".4"
      ...
      <path fill="none" stroke="#000" strokeWidth=".5"
            d="M189.7 214.5v-4.2m-1.2 4.1v-4" />
      <path fill="none" stroke="#000" strokeWidth=".6"
            d="M186 214v-3m1.3 3.2v-3.5m-2.5 3.1V211" />
      <path fill="none" stroke="#000" strokeWidth=".7"
      ...
      <path fill="#c8b100" stroke="#000" strokeWidth=".5"
            d="M168.6 320.9c1.5.8 3.6 2 5.8 2.6l-.1-54.7h-5.7z" />
      <path fill="#c8b100" stroke="#000" strokeLinejoin="round" strokeWidth=".5"
            d="M158 301.6a24.4 24.4 0 0 0 5.5 15v-47.5h-5.4z" />
      <path fill="#c7b500" stroke="#000" strokeWidth=".5"
      ...
      <path fill="none" stroke="#000" strokeWidth=".4"
            d="M230.9 229.7v-.6l.1-.3-2.3-.1a5.9 5.9 0 0 1-2.3-1.2c-.8-.7-1.1-1-1.6-1.2-1.3-.2-2.3.4-2.3.4s1 .4 1.7 1.3 1.5 1.3 1.8 1.4c.6.2 2.6 0 3.1.1z" />
      <path fill="#ed72aa" stroke="#000" strokeWidth=".4"
      ...
      <path fill="#ffd691" stroke="#000" strokeWidth=".5"
      ...
      <path fill="#058e6e" stroke="#000" strokeWidth=".5"
      ...
      <path fill="#ad1519" stroke="#000" strokeWidth=".5"
    ...
    language: "pt",
    flag: <svg className="w-[1em] h-[1em]" xmlns="http://www.w3.org/2000/svg"
               xmlnsXlink="http://www.w3.org/1999/xlink" id="flag-icons-pt"
               viewBox="0 0 640 480">
      <path fill="red" d="M256 0h384v480H256z" />
      <path fill="#060" d="M0 0h256v480H0z" />
      <g fill="#ff0" fillRule="evenodd" stroke="#000" strokeLinecap="round"
      ...
      <g transform="translate(0 26.7)scale(1.06667)">
        <path fill="#fff" stroke="#000" strokeWidth=".7"
        ...
        <path fill="red" stroke="#000" strokeWidth=".5"
        ...
        <g id="pt-e">
          ...
          <use xlinkHref="#pt-d" width="100%" height="100%"
               transform="rotate(-45.2 312.8 180)" />
        </g>
        <use xlinkHref="#pt-d" width="100%" height="100%" x="45.7" />
        <use xlinkHref="#pt-e" width="100%" height="100%"
  ...
  return (
    <div
      ...
      <a href="/es" onClick={() => toggleLanguage("es")}
         className="hover:brightness-125">
        {FLAGS.find(item => item.language === "es")?.flag}
      </a>
      <a href="/pt" onClick={() => toggleLanguage("pt")}
         className="hover:brightness-125">
        {FLAGS.find(item => item.language === "pt")?.flag}
      </a>
    </div>
  );
}

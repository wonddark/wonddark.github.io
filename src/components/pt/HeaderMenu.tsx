    ...
    <div
      ...
      <nav className="w-fit mx-auto pt-14 pb-9">
        <ul
          ...
          <li>
            <a href="#projects"
               className={`${currentSection === "#projects" ? "border-b border-primary text-primary hover:brightness-125" : "text-default hover:border-b hover:border-primary hover:text-primary"} px-1.5 pb-1`}>Proyetos</a>
          </li>
          <li>
            <a href="#contact"
               className={`${currentSection === "#contact" ? "border-b border-primary text-primary hover:brightness-125" : "text-default hover:border-b hover:border-primary hover:text-primary"} px-1.5 pb-1`}>Contato</a>
          </li>

    ...
    <div
      ...
      <nav className="w-fit mx-auto pt-14 pb-9">
        <ul
          ...
          <li>
            <a href="#toolbox"
               className={`${currentSection === "#toolbox" ? "border-b border-[#009394] text-[#009394] hover:brightness-125" : "hover:border-b hover:border-[#009394] hover:text-[#009394]"} px-1.5`}>Herramientas</a>
          </li>
          <li>
            <a href="#projects"
